...
void TrayControlWindow::my_peers_updated_sl() {
  ...
  if (!disconnected_peers.empty()) {
    ...
    QString msg = QString("Peer%1 %2 %3 disconnected")
  ...
  if (!disconnected_envs.empty()) {
    ...
    QString msg = QString("Environment%1 %2 %3 disconnected from your Peer")
  ...
  if (!new_connected_peers.empty()){
    ...
    QString msg = QString("Peer%1 %2 %3 connected")
  ...
  if (!new_connected_envs.empty()) {
    ...
    QString msg = QString("Environment%1 %2 %3 connected to your Peer")
